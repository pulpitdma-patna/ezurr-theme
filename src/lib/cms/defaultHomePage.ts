...
export const DEFAULT_HERO_SLIDES: HeroSlide[] = [
  {
    ...
    primaryCta: { label: "Pre-order now", href: "/checkout?key=gta-vi-preorder" },
    secondaryCta: { label: "View details", href: "/product?key=gta-vi-preorder" },
    showCountdown: true,
  ...
  },
  {
    ...
    price: "₹5,499",
    tags: ["Price locked", "COD available"],
    primaryCta: { label: "Pre-order now", href: "/checkout?key=zelda-preorder" },
    secondaryCta: { label: "View details", href: "/product?key=zelda-preorder" },
    showCountdown: false,
  ...
  },
  {
    ...
    strike: "₹74,490",
    saveTag: "Save ₹9,490",
    primaryCta: { label: "Add to bag", href: "/checkout?key=ezurr-play" },
    secondaryCta: { label: "View details", href: "/product?key=ezurr-play" },
    showCountdown: false,
